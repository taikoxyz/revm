...
## [0.11.0](https://github.com/taikoxyz/revm/compare/revme-v0.10.1...revme-v0.11.0) - 2024-09-13

### Added

- introducing EvmWiring, a chain-specific configuration ([#1672](https://github.com/taikoxyz/revm/pull/1672))
- *(statetest)* enable EOF in Prague tests ([#1753](https://github.com/taikoxyz/revm/pull/1753))

### Fixed

- statetest json set spec_id ([#1766](https://github.com/taikoxyz/revm/pull/1766))

### Other

- *(revme)* replace `structopt` with `clap` ([#1754](https://github.com/taikoxyz/revm/pull/1754))
