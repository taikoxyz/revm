...
## [5.1.0](https://github.com/taikoxyz/revm/compare/op-revm-v5.0.0...op-revm-v5.1.0) - 2025-05-29
...
- *(test)* preserve order of fields in json fixtures ([#2541](https://github.com/taikoxyz/revm/pull/2541))
